...
- (DRImageView *)iconView1 {
    if(_iconView1 == nil) {
        _iconView1 = [[DRImageView alloc] init];
...
- (DRImageView *)iconView2 {
    if(_iconView2 == nil) {
        _iconView2 = [[DRImageView alloc] init];
...
- (DRImageView *)iconView3 {
    if(_iconView3 == nil) {
        _iconView3 = [[DRImageView alloc] init];
...
- (DRImageView *)iconView4 {
    if(_iconView4 == nil) {
        _iconView4 = [[DRImageView alloc] init];
...
- (DRImageView *)iconView5 {
    if(_iconView5 == nil) {
        _iconView5 = [[DRImageView alloc] init];
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        yeView.backgroundColor = kRGBColor(254, 249, 236);
        self.selectedBackgroundView = yeView;
    }
    return self;
}
